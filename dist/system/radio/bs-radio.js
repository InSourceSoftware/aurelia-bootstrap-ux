...
System.register(['aurelia-framework'], function (_export, _context) {
  ...
  var bindable, bindingMode, _createClass, _dec, _dec2, _desc, _value, _class, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _descriptor8, BsRadio;
  ...
  return {
    ...
    execute: function () {
      ...
      _export('BsRadio', BsRadio = (_dec = bindable({ defaultBindingMode: bindingMode.twoWay }), _dec2 = bindable({ defaultBindingMode: bindingMode.twoWay }), (_class = function () {
        function BsRadio() {
